...
angular.module("../../templates/main-toc.tpl.jade", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../../templates/main-toc.tpl.jade",
    ...
    "LOCAL AND STATE COURTS</td><td class=\"description\">COMPARE DIFFERENT \n" +
    "TOPICS OVER TIME\n" +
    "SOMETHING ELSE</td></tr><tr><td><div class=\"arrow-icon\"></div></td><td><div class=\"arrow-icon\"></div></td><td><div class=\"arrow-icon\"></div></td></tr></tbody></table></div></div>");
}]);
